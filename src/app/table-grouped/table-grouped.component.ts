...
import { CarTableDataService } from '../car-table-data.ts.service';
import { CommonModule } from '@angular/common';
import * as myJson from '../../assets/data/car-list.json';
...
getData(): any {
   return myJson;
    ...
    myJson.data.forEach((item: any, index) => {
      item.id = index + 1;
    });
    this.allData = myJson.data;
